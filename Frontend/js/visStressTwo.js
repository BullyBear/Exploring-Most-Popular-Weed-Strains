...
d3.csv("../static/data/leafly/Frontend/assets/data/stress.csv", function(data) {
...
function makeGraph(nodes) {
  ...
  // var svg = d3.select("#stressBubble").append("svg")
  var canvas = d3.select("#stressBubble").append("canvas")
...
function makeGraph(nodes) {
  ...
  // var svg = d3.select("#stressBubble").append("svg")
  var canvas = d3.select("#stressBubble").append("canvas")
      .attr("class", "forceTransitionStressTwo")
      .attr("width", width)
      .attr("height", height)
      // .attr("viewBox", '0 -50  1000 1000')
      // .attr("viewBox", '0 -50  1250 1250')
...
function forceStressBubbleTwo() {


ScrollTrigger.create({
    trigger: "#stressBubble", 
    // onEnter: happyBubble()
    onEnter: () => {
      stressBubbleTwo();
    },
...
const resetVizBubbleStressTwo = (direction) => {
    ...
    // d3.selectAll("#stressBubble").style("opacity", 0);
     d3.selectAll("#stressBubble").style("opacity", 1).transition().duration(6000).style("opacity", 0);
