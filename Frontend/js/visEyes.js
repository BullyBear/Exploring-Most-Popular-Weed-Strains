...
d3.csv("../static/data/leafly/leafly/Frontend/assets/data/eyes.csv", function(data) {
...
d3.csv("/Frontend/assets/data/eyes.csv", function(data) {
  //calculate teh maximum group present
  m = d3.max(data, function(d){return d.group});
  //create teh color categories
  color = d3.scale.category10()
...
function forceEyesBubble() {


ScrollTrigger.create({
    trigger: "#startBubbleEyes", 
    // onEnter: happyBubble()
    onEnter: () => {
      eyesBubble();
    },
...
const resetVizBubbleEyes = (direction) => {
